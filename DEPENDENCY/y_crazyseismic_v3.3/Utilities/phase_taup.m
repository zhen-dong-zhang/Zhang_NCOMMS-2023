...
elseif strcmp(phase_name,'P410P')
    [rayp, taup, Xp]= y_get_PxP (evdp, np, em, 410);   
elseif strcmp(phase_name,'P660P')
    [rayp, taup, Xp]= y_get_PxP (evdp, np, em, 660); 
elseif strcmp(phase_name,'SxS')
    [rayp, taup, Xp]= y_get_SxS (evdp, np, em, xdep);  
elseif strcmp(phase_name,'S410S')
    [rayp, taup, Xp]= y_get_SxS (evdp, np, em, 410);     
elseif strcmp(phase_name,'S660S')
    [rayp, taup, Xp]= y_get_SxS (evdp, np, em, 660);  
elseif strcmp(phase_name,'S410P')
    [rayp, taup, Xp]= y_get_SxxP (evdp, np, em, 410); 
elseif strcmp(phase_name,'S660P')
    [rayp, taup, Xp]= y_get_SxxP (evdp, np, em, 660); 
