function [ zdt  ] = y_get_raypath_SxxP( evdp, rayp, em, xdep)
...
for i = 1:length(rayp)
    ...
    [rtmp2,dtmp2,dd2,zz2,etab2,edtab2] = tau_raypath_v2(xdep,ztS,pj,z_fine,ss_fine);
    [rtmp3,dtmp3,dd3,zz3,etab3,edtab3] = tau_raypath_v2(xdep,ztP,pj,z_fine,sp_fine);
    [rtmp4,dtmp4,dd4,zz4,etab4,edtab4] = tau_raypath_v2(0.,ztP,pj,z_fine,sp_fine);
